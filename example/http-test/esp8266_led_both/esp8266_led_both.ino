...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    String url = "";
    //    if (gpio == 1) {
    Serial.println("Preparing GPIO url");
    url = "http://iot-cuddle.000webhostapp.com/iot/api/led/read_all.php";
    //    } else if (gpio == 2) {
    ...
    if (httpCode > 0) {
      ...
      if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
        ...
        if (payload != NULL && payload.length() > 0) {
          ...
          String gpioId0 = json_parsed["led"][0]["id"];
          String gpioStatus0 = json_parsed["led"][0]["status"];
          Serial.println("gpioId0: " + gpioId0);
          Serial.println("gpioStatus0: " + gpioStatus0);

          String gpioId2 = json_parsed["led"][1]["id"];
          String gpioStatus2 = json_parsed["led"][1]["status"];
          Serial.println("gpioId2: " + gpioId2);
          Serial.println("gpioStatus2: " + gpioStatus2);
